        ...
        {personalityTests.map((test, index) => (
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#d8e2c8] bg-[#f6f8ef] text-sm font-semibold text-[#2f765f] dark:border-white/10 dark:bg-white/10 dark:text-[#d7e84f]">
                0{index + 1}
              </span>
            </div>
            ...
            <a
              ...
              className="focus-ring mt-6 inline-flex items-center justify-center gap-2 rounded-full bg-[#2f765f] px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#27644f] dark:bg-[#d7e84f] dark:text-slate-950 dark:hover:bg-[#e6ee75]"
            >
              开始测试
